...
export default function DashboardCharts() {
  ...
  const collabConfig: ChartConfig = {
    ...
    nonBillable: { label: t('charts.nonBillable'), color: 'hsl(var(--muted-foreground))' },
  };
          ...
          <CardContent>
            {hoursByCollab.length === 0 ? (
              ...
              <ChartContainer config={collabConfig} className="h-[350px] w-full">
                <BarChart data={hoursByCollab} layout="vertical" margin={{ left: 20, right: 20 }}>
          ...
          <CardContent>
            {top10Clients.length === 0 ? (
              ...
              <ChartContainer config={top10Config} className="h-[350px] w-full">
                <BarChart data={top10Clients} layout="vertical" margin={{ left: 20, right: 20 }}>
                  <CartesianGrid strokeDasharray="3 3" horizontal={false} />
                  <XAxis type="number" />
        ...
        <Card>
          ...
          <CardContent>
            {top10Matters.length === 0 ? (
              ...
              <ChartContainer config={top10Config} className="h-[350px] w-full">
                <BarChart data={top10Matters} layout="vertical" margin={{ left: 20, right: 20 }}>
                  <CartesianGrid strokeDasharray="3 3" horizontal={false} />
                  <XAxis type="number" />
                  <YAxis dataKey="name" type="category" width={100} tick={{ fontSize: 11 }} />
                  <ChartTooltip content={<ChartTooltipContent />} />
