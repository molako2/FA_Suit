  ...
  public: {
    Tables: {
      ...
      client_user_matters: {
        ...
        Relationships: [
          {
            foreignKeyName: "client_user_matters_client_id_fkey"
            columns: ["client_id"]
            isOneToOne: false
            referencedRelation: "clients"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "client_user_matters_matter_id_fkey"
            columns: ["matter_id"]
            isOneToOne: false
            referencedRelation: "matters"
            referencedColumns: ["id"]
    ...
    Enums: {
      app_role: "owner" | "assistant" | "collaborator" | "sysadmin" | "client"
    }
    CompositeTypes: {
      [_ in never]: never
    }
